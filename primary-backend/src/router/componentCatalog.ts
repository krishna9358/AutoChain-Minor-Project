  ...
  // ─── AI ─────────────────────────────────────────────────────
  {
    ...
    configFields: [
      ...
      },
      {
        ...
        description: "Quick-select a popular model, or use the Custom Model Name field below to override",
        options: [
      ...
      },
      {
        ...
        description: "Enter a custom model name. Overrides the model dropdown above if set.",
      },
      {
        key: "baseURL",
        label: "API Base URL",
        ...
        description: "Custom OpenAI-compatible endpoint URL. Leave empty to use default for selected provider.",
      },
      { key: "apiKey", label: "API Key", type: "password", required: false, placeholder: "sk-... or use {{secrets.OPENAI_KEY}}", description: "Provider API key (use secret references for safety). Optional for local providers." },
    ...
    configSchema: z.object({
      provider: z.enum(["openai", "anthropic", "google", "openrouter", "custom", "local"]).default("openai"),
