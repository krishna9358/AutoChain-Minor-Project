        ...
        <div className="flex bg-[#0B0B0F]/90 backdrop-blur-xl border-b border-white/[0.08] justify-between items-center px-4 py-3 sticky top-0 z-50 text-white rounded-b-2xl mx-2 mt-0 shadow-2xl">
            ...
            <div className="flex items-center gap-4 pr-1">
                ...
                <button
                    ...
                    className="text-sm font-semibold bg-gradient-to-r from-[#FF5A00] to-[#FF7A00] text-white px-5 py-2.5 rounded-full hover:shadow-[0_0_20px_rgba(255,90,0,0.3)] transition-all hover:scale-105 active:scale-95"
                >
                    Get Started
                </button>
            </div>
