        ...
        <section className="py-32 bg-[#0B0B0F] text-center border-t border-white/[0.02]">
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 text-left">
                    ...
                    <motion.div
                        whileHover={{ y: -5 }}
                        className="md:col-span-8 bg-[#15151A] border border-white/5 rounded-3xl p-10 relative overflow-hidden group"
                    >
                        <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-blue-500/10 rounded-full blur-[100px] pointer-events-none group-hover:bg-blue-500/20 transition-all duration-700" />
                        ...
                        <div className="absolute right-0 bottom-0 translate-x-1/4 translate-y-1/4 md:translate-x-0 md:translate-y-0 md:-right-10 md:top-1/2 md:-translate-y-1/2 pointer-events-none">
                            <div className="w-80 h-64 border border-white/10 bg-[#1C1C24] rounded-2xl p-6 shadow-2xl relative">
                                ...
                                <div className="flex gap-4 invisible md:visible">
                                    <div className="w-12 h-12 rounded-lg bg-[#FF5A00]/20 border border-[#FF5A00]/20"></div>
                                    <div className="w-12 h-12 rounded-lg bg-blue-500/20 border border-blue-500/20"></div>
                                </div>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    <motion.div
                        whileHover={{ y: -5 }}
                        className="md:col-span-4 bg-[#15151A] border border-white/5 rounded-3xl p-10 relative overflow-hidden group flex flex-col justify-between"
                    >
                        <div className="absolute -top-10 -right-10 w-[200px] h-[200px] bg-purple-500/10 rounded-full blur-[80px] pointer-events-none group-hover:bg-purple-500/20 transition-all duration-700" />
                        ...
                        {/* Dummy Chat Bubble */}
                        <div className="relative z-10 w-full bg-[#1C1C24] border border-white/10 rounded-xl p-4">
